...
import {AbilityCode, AbilityDict, Department, DepartmentInfo, Person, PersonSubject} from "../assets/types";

const props = defineProps<{ stuffParserExpose: typeof StuffParser }>();
